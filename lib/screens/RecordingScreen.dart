...
class RecordingScreen extends StatefulWidget {
  ...
  const RecordingScreen({super.key, required this.projectName});
...
// Listen to amplitude changes (for visual feedback)
  ...
  List<List> _recordingList = [
    [
      "Verse1",
      "/storage/emulated/0/Recordings/myaudio_1729187892030.mp3",
      2,
      "Oct 17th"
    ],
    [
      "Prechorus",
      "/storage/emulated/0/Recordings/myaudio_1729188617816.mp3",
      10,
      "Oct 17th"
    ],
  ];
...
// Generate a unique file name based on timestamp
        ...
        audioPath =
            '/storage/emulated/0/Recordings/myaudio_$timeStamp.mp3'; // Unique path
...
// Title and Username
                              Positioned(
                                left:
                                    83, // Adjusted for better alignment with the image
                                top: 15,
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
